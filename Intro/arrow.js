...
<body id="body">
    ...
    <script>
        ...
        {/* document.getElementById("alert").onclick = () => alert(document.getElementById("popup-input")) */}
        ...
        {/* document.getElementById("hover-this").onmouseout = () => setBackgroundColorById(setbackgroundColorById("body", value)) */}
        ...
        {/* const mouseOverFucntion = (el) => el.style = "background-color: black" */}
    </script>
</body>
</html>
